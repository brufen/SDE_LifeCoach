...
public interface DataService {
	 ...
	 * @param measureType
	 * @param personId
	 * @return returns java.util.List<soap.Measure>
	 */
	@WebMethod
	...
	public List<Measure> readPersonMeasuresByTypeAndDate(
			@WebParam(name = "personId", targetNamespace = "") int personId,
			@WebParam(name = "measureType", targetNamespace = "") String measureType,
			@WebParam(name = "before", targetNamespace = "") String before,
			@WebParam(name = "after", targetNamespace = "") String after);

	/**
	 * 
	 * @param personId
	 * @return returns soap.Person
	 */
	@WebMethod
	...
	public void createPerson(
			@WebParam(name = "person", targetNamespace = "", mode = WebParam.Mode.INOUT) Holder<Person> person);
	 ...
	 * @param measureType
	 * @param personId
	 * @return returns java.util.List<soap.Goal>
	 */
	@WebMethod
	@WebResult(name = "measures", targetNamespace = "")
	...
	/**
	 * 
	 * @return returns java.util.List<soap.Person>
	 */
	@WebMethod
	...
	/**
	 * 
	 * @return returns java.util.List<soap.MeasureType>
	 */
	@WebMethod
	...
	public Measure savePersonMeasurement(
			@WebParam(name = "personId", targetNamespace = "") int personId,
			@WebParam(name = "measure", targetNamespace = "") Measure measure);

	/**
	 * 
	 * @param personId
	 * @param goal
	 * @return returns soap.Goal
	 */
	@WebMethod
	@WebResult(name = "savePersonMeasurment", targetNamespace = "")
	...
	public Goal savePersonGoal(
			@WebParam(name = "personId", targetNamespace = "") int personId,
			@WebParam(name = "goal", targetNamespace = "") Goal goal);
	...
	public void createMeasureType(
			@WebParam(name = "createMeasureType", targetNamespace = "", mode = WebParam.Mode.INOUT) Holder<MeasureType> createMeasureType);
